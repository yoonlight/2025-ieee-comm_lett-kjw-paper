...
\textcolor{red}{After the denosing networks are trained, diffusion-based posterior sampling is performed to estimate the channel using iterative manner as~\cite{zhouGenerativeDiffusionModels2025},}
\begin{equation}
