...
\textcolor{red}{
In this letter, the novel channel estimation algorithm has been proposed to address the trade-off between accuracy, pilot overhead, and complexity. The proposed method has been derived by approximating the likelihood score using the moment matching method and Tweedie's formula to enable accurate and efficient posterior sampling. From the simulation results, the proposed method has been confirmed to outperform the baselines in terms of estimation accuracy, while achieving a comparable latency to the SOTA DM-based estimator under low pilot overhead in both LOS and NLOS environments.
}
